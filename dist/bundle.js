...
class SvgRoot extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("svg", { width: w * s, height: h * s, transform: s ?
                Matrix2D_1.default.scale(s).toString() :
                '', 
            ...
            React.createElement(Draggable_1.default, null, this.props.children)));
    }
}
ReactDOM.render(React.createElement(SvgRoot, { width: w, height: h, scale: scale },
